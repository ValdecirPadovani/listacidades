package com.listaCidades.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.listaCidades.resource")).paths(PathSelectors.any()).build()
				.apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API para leitura manutenção de uma lista de cidades",
				"Esta API é utilizada para o gerenciamento de cadastro de cidades. Techno Software", "Versão 1.0",
				"BreveLinhk", new Contact("Techno Software", "Techno Software ", "technosoftwarer@technosoftwarer.com.br"),
				"Projeto privado", "Termos", Collections.emptyList());
	}
